"""
Lake development physics.

Contains functions for the thermodynamic evolution of a fully-formed lake
(depth >= 10 cm), including turbulent mixing, radiative transfer through
...
def radiative_transfer(cell, sw_in):
    ...
    if cell["lid"]:
        ...
        radiation_at_bottom = sw_entering_lake * np.exp(-tau_water * cell["lake_depth"])
        ...
        radiation_at_bottom = sw_penetrating * np.exp(-tau_water * cell["lake_depth"])
