...
def extra_cell_setup(cell):
    ...
    cell["Lfrac"] = np.ones(cell["vert_grid"]) * 0.15  # Initial liquid fraction
    cell["Lfrac"][0] = 0.25
...
def test_lake_development():
    ...
    lake.lake_development(cell, dt, met_data[0])
    ...
    npt.assert_almost_equal(lake_depth_highres, lake_depth_lowres, decimal=4)
