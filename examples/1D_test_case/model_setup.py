# TODO - check TODOs in docstrings, move docstrings to documentation file
#  but don't include in final runscript
"""
...
"""
# Initial density, use 'default' to use empirical formula for initial density
# profile
rho_init = "default"
T_init = "default"  # Initial temperature profile.
# Initial surface density, if using empirical formula for initial density
# profile. Otherwise, it is 500.
rho_sfc = 500
...
# We exploit the fact that this is a Python script, so can set up our data
# in Numpy arrays.
